...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        2 => 'The uploaded file exceeds the Maximum Permitted Size',
        3 => 'The uploaded file was only partially uploaded',
        4 => 'No file was uploaded',
        6 => 'Missing a temporary folder',
        7 => 'Failed to write file to disk',
        8 => 'A PHP extension stopped the file upload',
        'post_max_size' => 'The uploaded file exceeds the Maximum Size Permitted by Server',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/application/files/uploads/',
            'upload_url' => $this->get_full_url().'/application/files/uploads/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
