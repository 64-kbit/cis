...
<div class="span12" >
                    ...
                    <div class="tab-content">
                        <div id="upload_new" class=" tab-pane fade in active " style="padding:20px">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <ol >
                                        <li><a href="<?php echo base_url()?>upload_file/get_file?file=students_template.csv&type=loans&token=token" target="_blank">Download template file here.</a> Insert contents in the template file</a> </li>
        ...
        <div id="tab-3">
           <!-- <div class="options-menu">
            <div class="btn-group">
                <button data-toggle="dropdown" class="btn dropdown-toggle">Actions Menu <span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li><a  data-toggle="modal" data-target="#view-item-data" href="<?php echo base_url() ?>admin/ajax_load/?name=admit_applicants&type=all&token=<?php echo $currenttoken ?>"><i class="fa icon-plus"></i>&nbsp;Admit All</a></li>
                    <li><a  data-toggle="modal" data-target="#view-item-data" href="<?php echo base_url() ?>admin/ajax_load/?checkclass=applicants&name=admit_applicants&type=checked&token=<?php echo $currenttoken ?>"><i class="fa icon-plus"></i>&nbsp;Admit Checked</a></li>
                    <li class="divider"></li>
 ...
 <script>
     ...
     /*
           ...
           */
     jQuery('#notadmitted_students-list-table').dataTable( {
...
<script>
    jQuery('#applicants_list-list-table').dataTable( {
        "scrollCollapse": true,
        "deferRender": true,
        "aaSortingFixed": [[0,'asc']],
        "columns": [
