...
<div id="dashboard-left" class="span8">
    ...
    <ul class="shortcuts">
        ...
        <li class="last images">
            <a onclick="alert('Feature In Progress');return false;" href="<?= base_url() . user_profile($userdata['profile']) ."/message/announcement" ?>">
                <span class="shortcuts-icon fa icon-volume-up fa fa-rotate-270"></span>
    ...
    <div id="tabs" class="tabbedwidget tab-primary ">
        <ul >
            <li><a  href="#tabs-1"><span class="fa fa fa-group "></span></a></li>
            <li><a  href="#tabs-2"><span class="glyphicon fa fa-envelope-alt "></span></a></li>
            <li><a  href="#tabs-3"><span class="fa fa fa-comments"></span></a></li>
        </ul>
...
<div class="alert alert-block">
    ...
    <h4>Warning!</h4>
    <p style="margin: 8px 0">Warning Messge!!</p>
</div><!--alert-->
