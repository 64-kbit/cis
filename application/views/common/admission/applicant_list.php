        ...
        <div class="headtitle">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a  data-toggle="modal" data-target="#add-item-data" href="<?php echo base_url() ?>ajax_load/form?name=new_student&token=<?php echo $currenttoken ?>"><i class="fa fa-plus"></i>&nbsp;Add New Student</a></li>
                    <li class="divider"></li>
                    <li><a href="#" onclick="alert('Not Implemented')"><i class="fa  fa-print"></i>&nbsp;Print List</a></li>
                </ul>
            </div>
            <h4 class="widgettitle"><?php echo $config['org_abbr'] ." ". $config['org_type'] ?> &nbsp;Selected Applicants Students</h4>
        </div>
